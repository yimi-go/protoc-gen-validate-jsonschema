...
func schemaOfSFixed64FieldType(bc pgs.BuildContext, rules *validate.FieldRules) *schemaObject {
	bc.Debugf("handling sfixed64 field")
	...
	r := rules.GetSfixed64()
	if r == nil {
		bc.Debugf("sfixed64 rule not found")
		return fieldSo
	}
	if r.Const != nil {
